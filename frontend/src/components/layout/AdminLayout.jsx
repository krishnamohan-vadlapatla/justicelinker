                    ...
                    {sidebarOpen ? (
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-gray-300 truncate max-w-[80px]">{user?.fullName || 'Admin'}</span>
                            </div>
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-brand-orange to-navy-400 flex items-center justify-center text-sm font-bold mx-auto">
                                {user?.fullName?.[0] || 'A'}
                            </div>
                            <button onClick={handleLogout} className="p-2 text-gray-400 hover:text-red-400 transition-colors rounded-lg hover:bg-red-500/10 mx-auto" title="Logout">
                                <LogOut size={18} />
                            </button>
                        </div>
                    )}
